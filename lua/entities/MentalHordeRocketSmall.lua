...
scripted_ents.Register( ENT, "MentalHordeRocketSmall" )
...
local CEntity_PhysicsInitBox = CEntity.PhysicsInitBox
local CEntity_SetHealth = CEntity.SetHealth
local CEntity_SetMaxHealth = CEntity.SetMaxHealth

function ENT:Initialize()
	CEntity_SetModel( self, "models/ss3_beheaded_rt_shell.mdl" )
	CEntity_PhysicsInitBox( self, Vector( -8, -8, -8 ), Vector( 8, 8, 8 ), "Metal" )
	CEntity_SetHealth( self, 128 )
	CEntity_SetMaxHealth( self, 128 )
	ParticleEffectAttach( "SS3_ROCKETMAN_TRACER", PATTACH_ABSORIGIN_FOLLOW, self, 0 )
	ParticleEffectAttach( "SS3BFE_RocketeerFlare", PATTACH_ABSORIGIN_FOLLOW, self, 0 )
end

ENT.__PROJECTILE_EXPLOSION__ = true
ENT.EXPLOSION_flDamage = 128
...
function ENT:Detonate( MyTable )
	...
	ParticleEffect( "SS3_Rocketeer_Grenade_Explosion", v, Angle( 0, 0, 0 ), nil )
